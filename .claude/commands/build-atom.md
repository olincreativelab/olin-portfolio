---
description: "Synchronise la planche de spécification Figma directement depuis la fiche Markdown d'Obsidian avec confirmation de cible."
---

Pour synchroniser ou revoir le composant `$ARGUMENTS` (par défaut `Button_Primaire`) :
